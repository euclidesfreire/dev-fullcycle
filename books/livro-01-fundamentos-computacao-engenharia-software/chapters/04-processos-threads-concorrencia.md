...
Um sistema profissional falha exatamente nas fronteiras que o iniciante costuma ignorar: recursos compartilhados, permissões, concorrência, limites de ambiente e sinais incompletos. Dominar processos, threads e concorrência é aprender a enxergar essas fronteiras antes que elas virem incidente.
...
Estude documentação do sistema operacional usado no seu ambiente, conceitos de processos, arquivos, permissões, containers, observabilidade e confiabilidade. Este capítulo aprofunda concorrência e prepara o estudo de memória, redes e arquitetura de software.
...
A próxima etapa aprofunda memória, localidade, alocação, garbage collection e efeitos de performance em aplicações reais.
